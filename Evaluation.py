...
class Ui_EvaluateWindow(object):
    ...
    def retranslateUi(self, EvaluateWindow):
        ...
        self.SelectTeam.setItemText(0,_translate('EvaluateWindow', "__SELECT TEAM__"))
        self.Selectmatch.setItemText(0,_translate('EvaluateWindow', "__SELECT MATCH__"))
